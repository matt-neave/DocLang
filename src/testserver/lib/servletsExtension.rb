...
class ServletExtStatus < WEBrick::HTTPServlet::AbstractServlet
...
class ServletExtRun < WEBrick::HTTPServlet::AbstractServlet
...
class ServletExtRunOne < WEBrick::HTTPServlet::AbstractServlet
...
class ServletExtSourceFile < WEBrick::HTTPServlet::AbstractServlet
...
class ServletExtBinaryFile < WEBrick::HTTPServlet::AbstractServlet
  def initialize(config, test_cases_path)
    super
    @test_cases_path = File.absolute_path(test_cases_path)
  end
